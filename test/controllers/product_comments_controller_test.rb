...
class ProductCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_comment" do
    assert_difference("ProductComment.count") do
      post product_comments_url, params: { product_comment: { comment: @product_comment.comment, product_id: @product_comment.product_id, user_id: @product_comment.user_id } }
    end
  ...
  test "should update product_comment" do
    patch product_comment_url(@product_comment), params: { product_comment: { comment: @product_comment.comment, product_id: @product_comment.product_id, user_id: @product_comment.user_id } }
